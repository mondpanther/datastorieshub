...
subtitle: "Learning to tell stories with data"
background-image: url(https://www.dropbox.com/s/knniizgk5e48sq8/Picture1.png?dl=1)
author: "Ralf Martin"
institute: "Imperial College Business School"
date: '2020/09/1 (updated: `r Sys.Date()`)'
output:
  xaringan::moon_reader:
    ...
    seal: false
params: 
    background_img: "figures/Picture1.png"      
editor_options: 
...
background-image: url(figures/Picture1.png)
background-size:  cover

<!--
background-image: url(`r params$background_img`)
class: inverse, title-slide center middle
...
#  `r kableExtra::text_spec(rmarkdown::metadata$title, color = "red")`


## `r kableExtra::text_spec(rmarkdown::metadata$author, color = "red")`


#### `r kableExtra::text_spec( paste0("Last modified: ",Sys.Date()), color = "red")`
...
>- Give you practical skills including
   - Data handling
   - Programming

--

>- Enable you to inform decisions with data

--

In short: We want you to get your hands dirty with data and coding


![](figures/dirtyhands.png)
...
>- You most likely will have to deal with developpers in your career. To do that effectively you need a basic grasp of coding.


![](figures/numbers.jpg){width=10%}
...
- Name: Ralf Martin   <img src="figures/mini.jpg" style="width: 30%" />



- Office: CAGB 487 (haven't been there much of late)

--

#### Some of the stuff I like:
- Playing with Business Micro data
- Figuring out how to increase growth without harming the planet
- Windsurfing
...
#### Dheeya Rizmie 
<img src="figures/dheeya.jpg" style="width: 15%" />
...
#### Petra Sarapatkova 
<img src="figures/petra.jpg"  style="width: 15%" />
