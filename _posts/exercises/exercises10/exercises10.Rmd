...
df=df %>% mutate( period2Xnonfree= (free==1) & ( as.character(period)=="2" ) )
...
We can control for the first issue by including `nonfree` as a control variable as (it measures how different the `nonfree` firms were before they received free permits). The second issue we can address with a period dummy variable. Hence:
