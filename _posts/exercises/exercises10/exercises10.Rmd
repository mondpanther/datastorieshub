...
(a)	Run an OLS regression of the clean innovation share on the Zsocial and oil price variables controlling for period effects. Report your regression in your answer. (A copy of your STATA output is sufficient)
...
(a)	Run a regression of the change in (log) unemployed on change in support. What do you find? How can you interpret the regression? [5 points]
