...
```{r }
mod_inter=lm(log(va)~log(k)+log(l)+sic3dig*log(k)+sic3dig*log(l)+sic3dig+year, prod, subset=prod$ysic3dig=="311"|subset=prod$ysic3dig=="321")
summary(mod_inter)
...
mod_fe=plm(log(va)~log(k)+log(l)+sic3dig*log(k)+sic3dig*log(l)+sic3dig+year, index=c("id","year"),data=prod, subset=prod$ysic3dig=="311"|subset=prod$ysic3dig=="321", model="within")
summary(mod_fe)
