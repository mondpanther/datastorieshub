...
Is the effect of beauty on course_eval big or small? `r mcq(c("Big", answer = "Small"))` How would you go about assessing this?

`r hide("Answer:")`

Going from the 25th to the 75th percentile on the beauty scale corresponds to a change of 1.2 “beauty”.
That implies a change of 0.16 teaching scores. Hence, you should not despair as a teacher when you are ugly (phew). It’s not a enough to move a below average teacher (e.g. at 25th percentile) to above average.
