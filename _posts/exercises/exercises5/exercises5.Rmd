...
We see that most CVs never received a call back (i.e. overall only 8.05% received a call back). However, there seems to be a clear difference between the races. Whereas for white people call back rates where above average (9.65%) they were below average for black people (6.45%) suggesting a racial bias by employers.

# Exercise 2
```{r}  
  library(foreign)
  data <- read.dta("../data/bm.dta")
```
