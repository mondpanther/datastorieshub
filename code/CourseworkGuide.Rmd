...
This document (you find the Rmd file for this document under [this](https://mondpanther.github.io/datastorieshub/code/CourseworkGuide.Rmd) link) provides you with a template or (draft) example on how your submission could look like. You should start with an introduction that motivates what you are working on. What question or issue are you going to address? 
