---
title: "Rrrr - Software for Pirates"
...
## Installing
Install R and R studio. Think of R studio as a kind of remote control for R which is the main "engine" that actually does all the work
...
Unlike a programme like Excel or Word where you do most things by clicking on menus, you interact with R primarily by issuing commands. The most basic way to that is by writing a command in the console window. 
...
when we print something shows up. You can use this as a pocket calculator
