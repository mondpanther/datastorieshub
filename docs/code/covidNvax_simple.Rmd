...
An increase of 1 additional vaccination per 100K leads to `r abs(round(reg1[["coefficients"]][["vax"]],2))` 
`r ifelse(reg1[["coefficients"]][["vax"]]<0,"less","more")` deaths per 1 million.
...
Is the causal effect of vaccines on detahs  really that low?
...
i.e. an increase of 1 additional vaccination per 100K leads to `r abs(round(reg2[["coefficients"]][["vax"]],2))` less deaths per 1 million; i.e. a much bigger effect than before.
