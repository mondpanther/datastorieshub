...
Below we illustrate this with some data from ongoing research. For some background see [here](https://blogs.lse.ac.uk/businessreview/2021/02/11/increasing-support-for-clean-innovation-a-win-win-win-strategy/).

The data has information on the knowledge spillover flows between different technological fields.
In particular we are looking at the spillover flow (using an estimate of the economic value of spillovers) from COVID related technologies to either clean, dirty or grey technologies.
