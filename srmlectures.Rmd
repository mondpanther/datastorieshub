---
title: "JH-IBSc - Social Research Methods 2021" 
...
Welcome to Social Research Methods.

This module consists of two parts:

Part I - Qualitative Research Methods

In this part you will be introduced to the main differences between qualitative and quantitative methods, before focusing on key themes for designing and executing qualitative research. In particular, you will develop an understanding of how to formulate research purposes and questions to study healthcare organizations, how to choose the research setting through purposeful sampling, and how to collect and analyse interview data. You will also familiarize with some of the most relevant methodologies (e.g., grounded theory, ethnography, etc.) 

Part II - Quantitative methods

In this part we give you an introduction into common concepts and tools for data analysis in economics and business. Emphasis will be on practical data skills as well as the ability to formulate a question appropriately, provide data analysis relevant to the question and interpret the results correctly. As part of the course you will be asked to provide a small piece of data analysis.
...
In this session, you will learn the main dimensions along which qualitative and quantitative research differ, and how each set of methods enables to investigate different phenomena. You will then explore examples of relevant research questions in healthcare settings and try your hand at developing your own. You will learn the criteria for choosing an ideal research setting.
...
In this session, you will learn how to develop interview protocols and to identify the main issues in collecting interview data for inductive research. You will also gain familiarity with the main technique for analysing textual data and with the validity criteria of inductive theory. Finally, you will get introduced to the main methodologies for conducting inductive research.
...
- [R - A good friend with a difficult personality](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7063554/)
...
To prepare for the exam also see the extra exercises: [Exercises 10](https://mondpanther.github.io/datastorieshub/posts/exercises/exercises10/)
...
# Datasets used in class (and more)
